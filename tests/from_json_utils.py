...
def run_tests_from_json(fname, test_func, globs, SECTION_MATCH=None, TEST_MATCH=None, PRINT_NAME=False):
        ...
        for (section_name, section_tests) in tests.items():
            ...
            for test in section_tests:
                ...
                if (not TEST_MATCH) or (TEST_MATCH in name):
                    test_methods[name] = create_test_wrapper(test_func, test["steps"], name, PRINT_NAME)
